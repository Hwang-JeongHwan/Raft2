...
var total_time = 0;
var total_time2 = 0;
var before_port = '9004';

var random = Random.getRandom(1000,2000);
var random1 = 2462.1086229919283;

var randomI = Random.getRandom(500,1500);
var randomI1 = 1845.4471561466069;
...
var json = '{"id":"app","key":"x","value":1,"cnt":0,"start":0,"key1":"x1","value1":1,"key2":"x2","value2":2,"key3":"x3","value3":1}'//JSON형식으로 선언
...
const interval = setInterval(() => { // timeout 을 설정하기위해 -> udp모듈중 timeout을 설정하는 모듈도 없을 뿐더러 3일간 구현해보려  했지만 실패하여 2~3초마다 메시지를 보내는 함수 구현
    ...
    var itv = '{"id":"app","interval":"interval"}';
